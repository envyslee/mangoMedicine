 ...
 */
public class QuantityChoose extends LinearLayout implements View.OnClickListener {
    ...
    public QuantityChoose(Context context) {
        super(context);
        init(null, 0);
    }

    public QuantityChoose(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public QuantityChoose(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mButtonAdd.setPadding(dp10, dp4, dp10, dp4);
        //mButtonAdd.setHeight(48);
        ...
        mButtonRemove.setPadding(dp10, dp4, dp10, dp4);
        //mButtonRemove.setHeight(48);
        ...
        mTextViewQuantity.setHeight(30);
